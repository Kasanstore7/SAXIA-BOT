...
global.fgif = {
		...
		// Fake 🤥
		global.ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999999999999999999999999999999999999999999999999, status: 1, surface: 1, message: '>SaxiaMiaw<', orderTitle: 'By Kasan', sellerJid: '0@s.whatsapp.net' } } }
