...
async function before(m) {
  ...
  const messages = {
    ...
    29: `telah menjadikan @${m.messageStubParameters[0].split('@')[0]} sebagai admin , Selamat yaaa🗿`,
    30: `telah memberhentikan @${m.messageStubParameters[0].split('@')[0]} dari admin , *awokawok*`,
    ...
    71: `ingin bergabung ke grup ini 📨`,
    74: `mengirim media sekali Lihat  📷`,
