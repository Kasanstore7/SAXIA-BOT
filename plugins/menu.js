...
"```Loading....😨```",
  "*Sukses Memuat Menu*"
    ...
    const { key } = await conn.sendMessage(m.chat, { text: 'Tunggu Sebentar Kak' }, { quoted:m})
...
await conn.sendFile(m.chat, sound, 'menu.opus', null, m, true, {
type: 'audioMessage', 
ptt: true, contextInfo: {
        externalAdReply: { showAdAttribution: true, title: wm,
 body: wm, sourceUrl: gcbot, thumbnail: await (await fetch('https://telegra.ph/file/7c71907225f33f3ba5eb6.jpg')).buffer()}} 
     })
    
conn.reply(m.chat, text, fgif, adReply)
  } catch (e) {
