...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            const isOwner = isROwner || m.fromOwner
...
global.dfail = (type, m, conn) => {
    let tsan = 'https://telegra.ph/file/2de52479e52441d2cd549.jpg'
    let msg = {
...
renderLargerThumbnail: true
    ...
    let msg2 = {
        premium: `${global.danied}\n\nPerintah Ini Hanya Untuk Pengguna Premium Beli Premium Di : @${global.owner[0]}`
    }[type]
